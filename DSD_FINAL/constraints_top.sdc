...
set OUTPUT_DELAY 0.5
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 0.3 [get_ports WriteData]
set OUTPUT_DELAY 0.5
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 0.3 [get_ports DataAdr]
set OUTPUT_DELAY 0.5
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 0.3 [get_ports MemWrite]
